  ...
  const [recommendation , setRecommendation]= useState([]);
    ...
    const addToFavourite = async()=>{
      try{
        ...
        const response = await fetch(`https://movie-flax-ten.vercel.app/api/favourites`,{
          method: 'POST',
          headers:{
    ...
    const addToWatchLater = async()=>{
      ...
      try{
      const response = await fetch(`https://movie-flax-ten.vercel.app/api/watchlater`,{
        method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    useEffect(()=>{
        const getMovie = async()=>{
            const response = await fetch(`https://movie-flax-ten.vercel.app/api/movies/movie/${movieId}`);
            const data = await response.json();
        ...
        const fetchMovieDetails = async () => {
          const response = await fetch(`https://movie-flax-ten.vercel.app/api/movies/info/${movieId}`);
          const data = await response.json();
